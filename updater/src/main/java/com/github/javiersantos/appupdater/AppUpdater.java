...
public class AppUpdater implements IAppUpdater {
    ...
    public interface UpdateAvailableListener {
        void isAppUpdateAvailable(Boolean isUpdateAvailable);
    }
    ...
    @Override
    public AppUpdater setUpdateAvailableListener(UpdateAvailableListener updateAvailableListener) {
